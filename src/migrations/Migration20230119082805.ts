...
export class Migration20230119082805 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "virgin" ("id" text not null, "guild_snowflake" text not null, "created_at" timestamptz(0) not null default now(), "updated_at" timestamptz(0) not null default now(), "username" text not null, "discriminator" text not null, "cached_dur_in_vc" int not null default 0, constraint "virgin_pkey" primary key ("id", "guild_snowflake"));');
